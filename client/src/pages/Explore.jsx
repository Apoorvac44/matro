        ...
        <div className="min-h-screen bg-white flex flex-col font-sans">
            ...
            <div className="px-4 md:px-6 py-3 bg-white border-b border-gray-100 flex gap-2 overflow-x-auto no-scrollbar whitespace-nowrap z-10">
                ...
                <div className="relative shrink-0">
                    ...
                    <button className={`flex items-center gap-1.5 px-4 py-1.5 rounded-full border text-[12px] font-medium transition-colors shadow-sm ${sortBy !== 'Relevance' ? 'border-[#800020] bg-red-50 text-[#800020]' : 'border-gray-200 bg-white text-gray-700 hover:bg-gray-50'}`}>
            ...
            <AnimatePresence>
                {showFilterModal && (
                    <>
                        ...
                        >
                            <div className="bg-[#800020] px-4 py-4 flex items-center gap-4 shadow-md shrink-0">
                                <button onClick={() => setShowFilterModal(false)} className="text-[#D4AF37] hover:bg-white/10 p-1.5 rounded-full transition-colors active:scale-90">
                            ...
                            <div className="absolute bottom-0 left-0 w-full bg-white border-t border-gray-200 px-4 py-4 shrink-0 shadow-lg z-10">
                                ...
                                <button
                                    onClick={() => setShowFilterModal(false)}
                                    className="w-full py-3.5 bg-[#800020] text-[#D4AF37] rounded-xl font-bold hover:bg-[#600318] transition-all active:scale-[0.98]"
                                >
                                    Show Matches
                                </button>
                            </div>
