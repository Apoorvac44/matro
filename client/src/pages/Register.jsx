...
const registrationSchema = z.object({
    ...
    maritalStatus: z.enum(['Single', 'Divorced', 'Widowed'], { required_error: 'Marital status is required' }),
...
const Register = () => {
    ...
    const renderProgress = () => (
        <div className="mb-10">
            <div className="flex justify-between items-center mb-4">
                <span className="text-[10px] font-bold text-[#800020] uppercase tracking-[0.3em]">Phase {step} of 4</span>
                <span className="text-[10px] font-bold text-[#D4AF37] uppercase tracking-widest">{Math.round((step / 4) * 100)}% Complete</span>
            </div>
    ...
    return (
        <div className="min-h-screen bg-[#FFFDD0]/20 flex items-center justify-center p-4 md:p-8 pt-28">
            <div className="max-w-6xl w-full bg-white rounded-[3rem] shadow-2xl shadow-[#800020]/5 overflow-hidden flex flex-col md:flex-row min-h-[750px] border border-[#800020]/5">
